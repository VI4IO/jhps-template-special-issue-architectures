...
See below in \Cref{{sec:intro},{sec:acc_sem},{sec:sys_arch},{sec:sto_for},{sec:deep_dive},{sec:per_char},{sec:con_out}} an example for a rough structure of the expected sections in the final document.
